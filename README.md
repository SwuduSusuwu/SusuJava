...
- [`./susuwu/ImmutablePos.java`](./susuwu/ImmutablePos.java): `` public abstract class ImmutablePos implements java.lang.Cloneable, java.util.RandomAccess { /* `ImmutablePos` stores constant vectors (first-order tensors). Usage: `double acceptsConsts(ImmutablePos pos)`. */ ``
  ...
  - [`./susuwu/ImmutablePos2.java`](./susuwu/ImmutablePos2.java): `` public abstract class ImmutablePos2 extends ImmutablePos { /* `ImmutablePos2` is the 2-dimensional specialization of `class ImmutablePos`. Usage: `double acceptsConsts(ImmutablePos2 pos2)`. */ ``
