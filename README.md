...
- [`./susuwu/ImmutablePos.java`](./susuwu/ImmutablePos.java): `` public class ImmutablePos implements java.lang.Cloneable, java.util.RandomAccess { /* `ImmutablePos` stores constant vectors (first-order tensors). Usage: `double acceptsConsts(ImmutablePos pos)`. */ ``
  - [`./susuwu/Pos.java`](./susuwu/Pos.java): `` public class Pos extends ImmutablePos { /* `Pos` stores mutable vectors (first-order tensors). Usage: `void setsPos(Pos pos)`. */ ``
  - [`./susuwu/ImmutablePos2.java`](./susuwu/ImmutablePos2.java): `` public class ImmutablePos2 extends ImmutablePos { /* `ImmutablePos2` is the 2-dimensional specialization of `class ImmutablePos`. Usage: `double acceptsConsts(ImmutablePos2 pos2)`. */ ``
  - [`./susuwu/Pos2.java`](./susuwu/Pos2.java): `` public class Pos2 extends Pos { /* `class Pos2` is the 2-dimensional specialization of `class Pos`. Usage: `Pos2 position;` */ ``
...
- [`./susuwu/ImmutablePosBounds.java`](./susuwu/ImmutablePosBounds.java): `public class ImmutablePosBounds implements java.lang.Cloneable` \* Usage: `ImmutablePosBounds posBounds(PosBoundsMode);`: which stores how sims enforce bounds. \*/"
...
- [`./posts/FishSim.md`](./posts/FishSim.md) is split from [`../SusuPosts/posts/Human_ancestors_are_fish.md#request-java-fish`](https://github.com/SwuduSusuwu/SusuPosts/blob/69b7b1545ab51a1c1a562c0ac838a950bb086442/posts/Human_ancestors_are_fish.md#request-java-fish). **Notice**: moved source code from thus into [`./susuwu/FishSim.java`](./susuwu/FishSim.java) (`package susuwu.FishSim;`, so *GitHub* can do unit tests plus code reviews).
  - [./posts/ConcernsOfExistenceMonism.md](./posts/ConcernsOfExistenceMonism.md) ("**Realistic-simulation concerns of [*panpsychism*](https://plato.stanford.edu/entries/panpsychism/) / *existence monism* / [*neutral monism*](https://plato.stanford.edu/entries/neutral-monism/)**").
  - [./posts/MultiuserConcernsPlusGoals.md](./posts/MultiuserConcernsPlusGoals.md) ("**Multiuser concerns plus goals for sims**")
...
### Affiliates
You can use [_Capital 1_'s affiliate program](https://www.capitalone.com/bank/referrals/checking300/friend/?referralCode=06BEGSDPR&programCode=RAFOFFER300) to support `SusuJava` (the revenue allows to publish more for you).
