...
- [`./posts/FishSim.md`](./FishSim.md) is split from [`../SusuPosts/posts/Human_ancestors_are_fish.md#request-java-fish`](https://github.com/SwuduSusuwu/SusuPosts/blob/69b7b1545ab51a1c1a562c0ac838a950bb086442/posts/Human_ancestors_are_fish.md#request-java-fish). **Notice**: moved source code from thus into [`./susuwu/FishSim.java`](../susuwu/FishSim.java) (`package susuwu.FishSim;`, so *GitHub* can do unit tests plus code reviews).
  - [./posts/ConcernsOfExistenceMonism.md](./ConcernsOfExistenceMonism.md) ("**Realistic-simulation concerns of [*panpsychism*](https://plato.stanford.edu/entries/panpsychism/) / *existence monism* / [*neutral monism*](https://plato.stanford.edu/entries/neutral-monism/)**").
  - [./posts/MultiuserConcernsPlusGoals.md](./MultiuserConcernsPlusGoals.md) ("**Multiuser concerns plus goals for sims**")
...
- [`../SusuPosts/posts/2_dimensional_forge.md#grok-2s-java-parallax-version`](https://github.com/SwuduSusuwu/SusuPosts/blob/preview/posts/2_dimensional_forge.md#grok-2s-java-parallax-version) shows processes for extraction of *sprites* (a subset of *bitmaps*) from images, plus how to produce *parallax perspectives* with thus (for pseudo-volumetric motions).
