...
[Asof 2025-10-25](https://github.com/SwuduSusuwu/SusuLib/discussions/70#discussioncomment-14782700) ([`commit` 08743459f887fae33836a4c6da2f63342847b676](https://github.com/SwuduSusuwu/SusuJava/commit/08743459f887fae33836a4c6da2f63342847b676)), <https://github.com/SwuduSusuwu/> switches to a new certificate[^6]. The previous certificates are not known as "compromised", but were used on numerous devices (thus are no longer trustable).

[Asof 2025-11-30](https://github.com/SwuduSusuwu/SusuLib/discussions/70#discussioncomment-15120423) ([`commit` 5bec751e2bcff9dfd03eef2b3645c9028e4ce7c2](https://github.com/SwuduSusuwu/SusuJava/commit/5bec751e2bcff9dfd03eef2b3645c9028e4ce7c2)), <https://github.com/SwuduSusuwu/> switches to a new certificate[^7]. The previous certificates are not known as "compromised", but were used on numerous devices (thus are no longer trustable).
...
[^6]: Asof [`commit` 08743459f887fae33836a4c6da2f63342847b676](https://github.com/SwuduSusuwu/SusuJava/commit/08743459f887fae33836a4c6da2f63342847b676), [`./.ssh/sha256.sig`](./.ssh/sha256.sig) (plus the [`./.ssh/allowed_signers`](./.ssh/allowed_signers) which `sha256.sig` produces) use new sigs. All `commit`s which follow that `commit` must use those new sigs (hash is `SHA256:1ywl0RIdF6ZueX1qazgx1ihGDytfKYf9T97gONFroio`).

[^7]: Asof [`commit` 5bec751e2bcff9dfd03eef2b3645c9028e4ce7c2](https://github.com/SwuduSusuwu/SusuJava/commit/5bec751e2bcff9dfd03eef2b3645c9028e4ce7c2)), [`./.ssh/sha256.sig`](./.ssh/sha256.sig) (plus the [`./.ssh/allowed_signers`](./.ssh/allowed_signers) which `sha256.sig` produces) use new sigs. All `commit`s which follow that `commit` must use those new sigs (hash is `SHA256:KZ1xw3wO0BPce/uVl3qH4nULF0hnLL4NNKEhiko6ZK0`).
